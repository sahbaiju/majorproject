...
if(isset($_POST['submit'])) {	
    ...
    if(mysqli_num_rows($qsql) == 1) {
        ...
        <strong>Oh no!</strong> Invalid login credentials. Please try again.
        </div>";
    }
}
?>
...
function validateform() {
    if(document.frmadminlogin.loginid.value == "") {
        document.getElementById("err").innerHTML = "<div class='alert alert-info'><strong>Heads up!</strong> Please enter your Username.</div>";
        document.frmadminlogin.loginid.focus();
        return false;
    } else if(!document.frmadminlogin.loginid.value.match(alphanumericExp)) {
        document.getElementById("err").innerHTML = "<div class='alert alert-warning'><strong>Heads up!</strong> Username is not valid.</div>";
        document.frmadminlogin.loginid.focus();
        return false;
    } else if(document.frmadminlogin.password.value == "") {
        document.getElementById("err").innerHTML = "<div class='alert alert-info'><strong>Heads up!</strong> Please enter your Password.</div>";
        document.frmadminlogin.password.focus();
        return false;
    } else if(document.frmadminlogin.password.value.length < 8) {
        document.getElementById("err").innerHTML = "<div class='alert alert-info'><strong>Heads up!</strong> Password should be at least 8 characters long.</div>";
        document.frmadminlogin.password.focus();
        return false;
    } else {
        return true;
